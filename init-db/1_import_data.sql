CREATE TABLE IF NOT EXISTS raw_mock_data (
    id INTEGER,
...
BEGIN
    SELECT COUNT(*) INTO record_count FROM raw_mock_data;
    RAISE NOTICE 'imported records: %', record_count;
END $$;